...
class SimplePPOPolicy(object):
  ...
  """
    ...
    def __init__(self, sess, observation_space, action_space, network, policy_layers, value_layers, checkpoint):
        self.sess = sess
        self.observation_space = observation_space
        self.action_space = action_space
        observation_size = len(observation_space[0])
    ...
    def _normalize_observ(self, observ):
        min_ = self.observation_space[0]
        max_ = self.observation_space[1]
